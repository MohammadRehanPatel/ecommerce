...
const HomeSectionCard = ({ product }) => {
  return (
    <div className="flex gap-2 w-full">
      <div className="relative space-y-2 flex flex-col text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-full m-2 transition-all cursor-pointer hover:shadow-lg ">
